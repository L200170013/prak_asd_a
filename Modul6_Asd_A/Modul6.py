...
mh1 = mahasiswa("andi", 104, "a", 20000)
mh2 = mahasiswa("berina", 84, "b", 150000)
mh3 = mahasiswa("dena", 124, "c", 500000)
mh4 = mahasiswa("doni", 544, "d", 120000)
mh5 = mahasiswa("elsa", 4, "e", 250000)
